...
import 'package:project/Company%20Screens/Home_Screen.dart';
...
class AuthService {
  ...
  Future<void> _handleLogin(String email, BuildContext context) async {
    ...
    if (userSnapshot.docs.isNotEmpty) {
      ...
      _navigateToScreen(context, Home_Screen.routeName, 'Login successful! Redirecting to company home screen...', companyId);
    } else if (adminSnapshot.docs.isNotEmpty) {
      String adminId = adminSnapshot.docs.first.id;
      await _updateUserPlayerId(adminId, 'admin');
      _navigateToScreen(context, Adminms.routeName, 'Login successful! Redirecting to admin home screen...', adminId);
    } else {
  ...
  void _navigateToScreen(BuildContext context, String route, String message, [String? argument]) {
